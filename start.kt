...
//        })
        ...
        val window : Window = this@start.window
        window.statusBarColor = ContextCompat.getColor(this@start,R.color.backgroundMA)
        window.navigationBarColor = ContextCompat.getColor(this@start,R.color.backgroundMA)
